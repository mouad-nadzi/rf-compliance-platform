...
MODEL SELECTION:
    ...
    Available keys are defined in engines/registry.py.
"""

# ── Model Selection ──────────────────────────────────────────────────────────
# Which OCR engine to use (must match a key in engines/registry.py)
...
# Which LLM engine to use (must match a key in engines/registry.py)
...
CACHE_DIR: str = os.getenv("HF_HOME", os.getenv("CACHE_DIR", os.path.join(BASE_DIR, "model_cache")))
...
OCR_CACHE_DIR: str = os.getenv("OCR_CACHE_DIR", os.path.join(BASE_DIR, "ocr_cache"))
# Staging directory for uploaded files during batch ingestion.
BATCH_UPLOAD_DIR: str = os.getenv("BATCH_UPLOAD_DIR", os.path.join(BASE_DIR, "batch_uploads"))
