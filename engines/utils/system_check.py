"""
engines/utils/system_check.py — System readiness verification & initialization gate.
...
def check_llm_model() -> Dict[str, Any]:
    ...
    try:
        from engines.registry import get_llm_engine
...
def check_config() -> Dict[str, Any]:
    ...
    from engines.registry import OCR_REGISTRY, LLM_REGISTRY
    problems = []
