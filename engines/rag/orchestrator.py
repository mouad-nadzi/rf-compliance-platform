"""
engines/rag/orchestrator.py — End-to-End Dual-Path RAG Orchestrator

Unifies intent classification (engines.rag.router), Text-to-SQL (engines.rag.sql_engine),
and Hybrid RRF vector retrieval (engines.rag.hybrid_engine) into a single production entry point:
...
import config
from engines.rag.router import classify_intent, QueryIntent
from engines.rag.sql_engine import execute_metadata_query, FALLBACK_MESSAGE as SQL_FALLBACK
from engines.rag.hybrid_engine import (
